            ...
            <Header navigation={this.props.navigation} />
                ...
                <ScrollView style={styles.loyaltyScrollView}>
                 ...
                 <View style={styles.loyalty_stamp_row} > 
                    <TouchableOpacity  style={[styles.top_main_tab, styles.tab_active]} onPress={()=> this.props.navigation.navigate('LoyaltyVouchers')}>
                    ...
                    <TouchableOpacity style={styles.top_main_tab} onPress={()=> this.props.navigation.navigate('StampCard')}>
...
const styles = StyleSheet.create({    
    ...
    loyaltyScrollView:{ marginBottom:10,},
