        ...
        return(
            ...
            <View>
                ...
                <View style={styles.loyalty_stamp_row} > 
                    <TouchableOpacity  style={styles.top_main_tab} onPress={()=> this.props.navigation.navigate('LoyaltyVouchers')}>
                    ...
                    <TouchableOpacity style={[styles.top_main_tab, styles.tab_active]} onPress={()=> this.props.navigation.navigate('StampCard')}>
                        ...
                        <Modal isVisible={this.state.isModalVisible_2}>
                            ...
                            <View style={{position: 'absolute', zIndex:101, marginTop:0, paddingBottom:20, width:'100%'}}>
                                ...
                                <View style={[styles.ComponentModal, style={marginTop:0, paddingBottom:100, backgroundColor:'#da466b'}]}>                                
                                 ...
                                 <View style={{flexDirection:'row'}}>
                                <View style={[styles.modalbtnpanel, styles.bordergreencolor, style={borderWidth:0, backgroundColor:'#fff'}]}>
                                    <TouchableOpacity style={[styles.shopbtnbottom, style={ backgroundColor:'#fff'}]} onPress={this._toggleModal_2} >
                                        <Text style={{color: '#fff', fontSize:18, fontWeight:'bold',color:'#017218',}}>Close</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
...
const styles = StyleSheet.create({    
    ...
    marginBottom:15, marginTop:0, backgroundColor:'#fff'},
