  ...
  render() {
    return (
      ...
      <View style={{flex: 2.5}}>
        ...
        />
        <View style={[styles.inputContainer, style={marginTop: 10}]}>
          <Text style={[styles.textContainer, style={marginBottom: 10}]}>Gender</Text>
        ...
        <View>
          <View style={{flexDirection:'row', marginTop:15, justifyContent: 'center'}}>
            <CheckBox
              ...
              />
            <Text style={{color:'white', top: 16, left: -20, marginBottom:10}}>Please accept our Terms & Conditions</Text>
          </View>
      </View>
