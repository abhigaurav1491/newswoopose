    ...
    return (
      ...
      <View style={styles.container}>
        <View style={[styles.box, styles.boxfirst]}>
          <TouchableOpacity onPress={() => this.props.navigation.navigate("ProductCategorySearch")}>
        ...
        <View style={[styles.box, styles.boxsecond, styles.active]}>
          <TouchableOpacity onPress={() => this.props.navigation.navigate("StoresCategoryResult")}>
