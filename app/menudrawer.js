     ...
     <ScrollView>
          <View style={styles.container}>
            ...
            <View style={styles.bottomLinkks}>
                  {this.navLink('LoyaltyVouchers',  'Loyalty Points & Vouchers' , icon1) }
                  {this.navLink('My Orders','My Orders' , icon2)}
                  {this.navLink('Messages link','Messages' , icon3)}
                  {this.navLink('My Favourites','My Favourites', icon4)}
                  {this.navLink('Invite Friends','Invite Friends' , icon5)}
                  {this.navLink('Payment Details','Payment Details' , icon6)}
                  {this.navLink('Addresses','Addresses', icon7)}
                  {this.navLink('Settings','Settings' , icon8)}
            </View>
            ...
            <View style={styles.bottomLinkks}>
                  {this.navLink('Order for Collection','Order for Collection', icon9) }
