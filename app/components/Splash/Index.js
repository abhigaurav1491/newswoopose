...
import { StyleSheet, Text, View ,ImageBackground, Image, Dimensions,SafeAreaView,TouchableOpacity, AppRegistry } from 'react-native';
    ...
    return (
        ...
        <ImageBackground source={require('../../assets/images/splash-bg.jpg')} style={styles.container}> 
        	<View style={styles.splashlogo}> 
        		<Image style={{width:207, resizeMode: 'contain'}}  source={require('../../assets/images/logoblue.png')} />
        	</View>
          ...
          <TouchableOpacity onPress={() => this._skipSplashScreen()} style={styles.btnskip}><Text style={styles.btnskiptxt}>Skip</Text></TouchableOpacity>   
        </ImageBackground>
