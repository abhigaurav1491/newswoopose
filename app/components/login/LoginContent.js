		    ...
		    <View style={styles.inputContainer}>
		       <TextInput
			    ...
			    <View style={styles.rememberMeContainer}>
				    ...
				    <View style={{top: -10, left: -10, position: 'relative'}}>
				    <CheckBox 
			        ...
			        <View style={{flex:1,}}>
			        <Text style={[styles.textContainer, style={alignSelf: 'flex-end', marginTop: 5}]}>Forgot Password?</Text>
			        </View>
			    </View>
		    	...
		    	<View style={styles.socialContainer}>
		    		...
		    		{!this.state.signedIn ? (
		    			<TouchableOpacity style={styles.circle} onPress={() => this.gmailSignedIn()}>
							<Image source={require('../../assets/gmail-icon.png')} style={{alignItems:'center',justifyContent:'center',width:30, height: 30}} />
		    			</TouchableOpacity>
			        ) : (
		    		...
		    		{!this.state.userInfo ? (
			          	<TouchableOpacity style={styles.circle} onPress={this.loginViaFacebook}>
							<Image source={require('../../assets/fb-icon.png')} style={{width:30, height: 30}} />
		    			</TouchableOpacity>
			        ) : (
